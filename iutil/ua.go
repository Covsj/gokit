...
// UAConfig 存储所有User-Agent配置
type UAConfig struct {
	Android          []string `json:"android"`
	Chrome           []string `json:"chrome"`
	Computer         []string `json:"computer"`
	Firefox          []string `json:"firefox"`
	InternetExplorer []string `json:"internet-explorer"`
	IOS              []string `json:"ios"`
...
func init() {
	...
	defaultBrowser.loadConfig()
}

// loadConfig 加载ua.json配置文件
func (b *browser) loadConfig() {

	data := []byte(uas)

	b.config = &UAConfig{}
	if err := json.Unmarshal(data, b.config); err != nil {
		panic(fmt.Sprintf("解析UA配置文件失败: %v", err))
	}

	// 收集所有可用的UA字符串
	allUAs := make([]string, 0)
	allUAs = append(allUAs, b.config.Android...)
	allUAs = append(allUAs, b.config.Chrome...)
	allUAs = append(allUAs, b.config.Computer...)
	allUAs = append(allUAs, b.config.Firefox...)
	allUAs = append(allUAs, b.config.InternetExplorer...)
	allUAs = append(allUAs, b.config.IOS...)
	allUAs = append(allUAs, b.config.IPad...)
	allUAs = append(allUAs, b.config.IPhone...)
	allUAs = append(allUAs, b.config.Linux...)
	allUAs = append(allUAs, b.config.MacOSX...)
	allUAs = append(allUAs, b.config.Mobile...)
	allUAs = append(allUAs, b.config.Safari...)
	b.config.AllUa = allUAs

}

// Random 获取随机User-Agent字符串
func Random() string {
	return defaultBrowser.Random()
}

// Chrome 获取Chrome浏览器随机UA
func Chrome() string {
	return defaultBrowser.Chrome()
}

// InternetExplorer 获取IE浏览器随机UA
func InternetExplorer() string {
	return defaultBrowser.InternetExplorer()
}

// Firefox 获取Firefox浏览器随机UA
func Firefox() string {
	return defaultBrowser.Firefox()
}

// Safari 获取Safari浏览器随机UA
func Safari() string {
	return defaultBrowser.Safari()
}

// Android 获取Android设备随机UA
func Android() string {
	return defaultBrowser.Android()
}

// MacOSX 获取macOS系统随机UA
func MacOSX() string {
...
func (b *browser) Random() string {
	return b.getRandomUA(b.config.AllUa)
}

// Chrome 获取Chrome浏览器随机UA
func (b *browser) Chrome() string {
	return b.getRandomUA(b.config.Chrome)
}

// InternetExplorer 获取IE浏览器随机UA
func (b *browser) InternetExplorer() string {
	return b.getRandomUA(b.config.InternetExplorer)
}

// Firefox 获取Firefox浏览器随机UA
func (b *browser) Firefox() string {
	return b.getRandomUA(b.config.Firefox)
}

// Safari 获取Safari浏览器随机UA
func (b *browser) Safari() string {
	return b.getRandomUA(b.config.Safari)
}

// Android 获取Android设备随机UA
func (b *browser) Android() string {
	return b.getRandomUA(b.config.Android)
}

// MacOSX 获取macOS系统随机UA
func (b *browser) MacOSX() string {
	return b.getRandomUA(b.config.MacOSX)
}

// IOS 获取iOS系统随机UA
func (b *browser) IOS() string {
	return b.getRandomUA(b.config.IOS)
}

// Linux 获取Linux系统随机UA
func (b *browser) Linux() string {
	return b.getRandomUA(b.config.Linux)
}

// IPhone 获取iPhone设备随机UA
func (b *browser) IPhone() string {
	return b.getRandomUA(b.config.IPhone)
}

// IPad 获取iPad设备随机UA
func (b *browser) IPad() string {
	return b.getRandomUA(b.config.IPad)
}

// Computer 获取电脑设备随机UA
func (b *browser) Computer() string {
	return b.getRandomUA(b.config.Computer)
}

// Mobile 获取移动设备随机UA
func (b *browser) Mobile() string {
	return b.getRandomUA(b.config.Mobile)
}

// getRandomUA 从指定UA列表中获取随机UA
func (b *browser) getRandomUA(uas []string) string {
	if len(uas) == 0 {
		return ""
	}
	return uas[b.randGen.Intn(len(uas))]
}
